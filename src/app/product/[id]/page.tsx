          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            >
              ...
              <div className="space-y-4 mb-10">
                <h4 className="text-sm uppercase tracking-widest font-bold">Details</h4>
                <ul className="grid grid-cols-2 gap-y-3">
                  {product.details.map((detail, idx) => (
                    <li key={idx} className="text-sm text-foreground/50 flex items-center gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-gold/50" /> {detail}
                    </li>
                  ))}
                  <li className="text-sm text-foreground/50 flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-gold/50" /> {product.material}
                  </li>
                </ul>
              </div>
